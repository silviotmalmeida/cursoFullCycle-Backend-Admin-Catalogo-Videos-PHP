...
class FindByIdVideoUseCaseUnitTest extends TestCase
{
    ...
    public function testExecute(
        ...
        $mockRepository->shouldReceive('update')->times(0)->andReturn(); //definindo o retorno do insert()
        $mockRepository->shouldReceive('updateMedia')->times(0)->andReturn(); //definindo o retorno do insert()
        ...
        $mockFileStorage->shouldReceive('store')->times(0)->andReturn(); //definindo o retorno do store()
        $mockFileStorage->shouldReceive('delete')->times(0)->andReturn(); //definindo o retorno do delete()
        ...
        $mockCategoryRepository->shouldReceive('findByIdArray')->times(0)->andReturn(); //definindo o retorno do findByIdArray()

        // criando o mock do genreRepository
        $mockGenreRepository = Mockery::mock(GenreRepositoryInterface::class);
        $mockGenreRepository->shouldReceive('findByIdArray')->times(0)->andReturn(); //definindo o retorno do findByIdArray()

        // criando o mock do castMemberRepository
        $mockcastMemberRepository = Mockery::mock(CastMemberRepositoryInterface::class);
        $mockcastMemberRepository->shouldReceive('findByIdArray')->times(0)->andReturn(); //definindo o retorno do findByIdArray()
